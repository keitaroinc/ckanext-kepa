...
3. Add `kepa` to the `ckan.plugins` setting in your CKAN
...
To install ckanext-kepa for development, activate your CKAN virtualenv and
do:
...
## Releasing a new version of ckanext-kepa

If ckanext-kepa should be available on PyPI you can follow these steps to publish a new version:
